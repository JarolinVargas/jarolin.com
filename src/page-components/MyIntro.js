...
export default function MyIntro() {
    return (
        <div className="MyIntro">
            ...
            <motion.h3 className="my-title primary-color" initial="initial" animate="enter" exit="exit" variants={animations} transition={{delay: .05}}>Front-End Engineer - UI/UX Designer - Product Developer</motion.h3>
