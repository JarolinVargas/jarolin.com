...
export default function MyIntro() {
    return (
        <div className="MyIntro">
            ...
            <motion.h3 className="my-title aboutme-gradient" initial="initial" animate="enter" exit="exit" variants={animations} transition={{delay: .05}}>Front-End Developer &amp; UI/UX Designer</motion.h3>
