    ...
    return (
        <div className="IconLinks">
            <motion.ul variants={animations}>
                ...
                <li><a href="https://assets.ctfassets.net/0mo16etbpbdn/6jgB3Wr6gJq4KzxCLs5qBv/394106a9194320daf446e716297ffa3c/5666456-2f5f8f0e069784b9b97c6ca9880bc5ba.pdf" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faFileAlt} color="orange"/></a></li>
            </motion.ul>
        </div>
    )
}
